...
--
-- Host: localhost    Database: niab_functional
-- ------------------------------------------------------
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `halls` (
  `id_hall` tinyint NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `movies_projected`
--

DROP TABLE IF EXISTS `movies_projected`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `movies_projected` (
  `id_hall` tinyint NOT NULL,
  `id_allocine` mediumint NOT NULL,
  `estimated_entrances_hall` smallint DEFAULT NULL,
  `estimated_business_sales` mediumint DEFAULT NULL,
  `estimated_net_income` mediumint DEFAULT NULL,
  PRIMARY KEY (`id_hall`,`id_allocine`),
  KEY `movies_projected_movies_FK` (`id_allocine`),
  CONSTRAINT `movies_projected_halls_FK` FOREIGN KEY (`id_hall`) REFERENCES `halls` (`id_hall`) ON DELETE CASCADE,
  CONSTRAINT `movies_projected_movies_FK` FOREIGN KEY (`id_allocine`) REFERENCES `movies` (`id_allocine`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `movies_projected_history`
--

DROP TABLE IF EXISTS `movies_projected_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `movies_projected_history` (
  `id_hall` tinyint NOT NULL,
  `id_allocine` mediumint NOT NULL,
  `estimated_entrances_hall` smallint DEFAULT NULL,
  `real_entrances_hall` smallint DEFAULT NULL,
  `estimated_business_sales` mediumint DEFAULT NULL,
  `real_business_sales` mediumint DEFAULT NULL,
  `estimated_net_income` mediumint DEFAULT NULL,
  `net_income` mediumint DEFAULT NULL,
  PRIMARY KEY (`id_hall`,`id_allocine`),
  KEY `movies_projected_movies_FK` (`id_allocine`),
  CONSTRAINT `movies_projected_history_halls_FK` FOREIGN KEY (`id_hall`) REFERENCES `halls` (`id_hall`) ON DELETE CASCADE,
  CONSTRAINT `movies_projected_history_movies_FK` FOREIGN KEY (`id_allocine`) REFERENCES `movies` (`id_allocine`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `movies_projected_result`
--

DROP TABLE IF EXISTS `movies_projected_result`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `movies_projected_result` (
  `id_hall` tinyint NOT NULL,
  `id_allocine` mediumint NOT NULL,
  `estimated_entrances_hall` smallint DEFAULT NULL,
  `real_entrances_hall` smallint DEFAULT NULL,
  ...
  `net_income` mediumint DEFAULT NULL,
  PRIMARY KEY (`id_hall`,`id_allocine`),
  KEY `movies_projected_result_movies_FK` (`id_allocine`),
  CONSTRAINT `movies_projected_result_halls_FK` FOREIGN KEY (`id_hall`) REFERENCES `halls` (`id_hall`) ON DELETE CASCADE,
  CONSTRAINT `movies_projected_result_movies_FK` FOREIGN KEY (`id_allocine`) REFERENCES `movies` (`id_allocine`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-04-15 16:37:15
