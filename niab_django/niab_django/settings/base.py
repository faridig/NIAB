"""
Django settings for niab_django project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'niab_django.context_processors.global_variables',
            ],
        },
    },
]

WSGI_APPLICATION = 'niab_django.wsgi.application'
